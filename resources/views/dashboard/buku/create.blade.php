...
<div class="row justify-content-center">
	<div class="col-lg-6">
		<form method="POST" action="/buku-dashboard" enctype="multipart/form-data">
			@csrf
			<div class="card">
				<div class="card-header text-center ">
					<b>Form Insert Buku</b>
				</div>
				<div class="card-body">
					<div class="mb-3">
					...
					<div class="mb-3">
						...
						<input type="text" class="form-control @error('klasifikasi') is-invalid @enderror" id="klasifikasi"  name="klasifikasi" value="{{old('klasifikasi')}}">
						@error('klasifikasi')
						<div class="invalid-feedback">
							{{$message}}
						</div>
					...
					<div class="mb-3">
						...
						<input type="file" name="file_upload" value="{{old('file_upload')}}" class="form-control @error('file_upload') is-invalid @enderror">
						@error('file_upload')
						<div class="invalid-feedback">
							{{ $message }}
						</div>
