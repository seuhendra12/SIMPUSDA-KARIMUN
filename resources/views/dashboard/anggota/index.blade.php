  ...
  <div class="alert alert-danger alert-dismissible fade show" role="alert">
    ...
    <div class="alert alert-primary alert-dismissible fade show" role="alert">
      ...
      <div class="col">
        ...
        <a href="{{url('anggota-dashboard')}}/create" class="btn" style="background-color: #4682B4;color: white;"><i class="fa fa-pencil-alt"></i>  Tambah Data</a>
        <div class="row mt-4">
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-tools">
                  <form class="form" action="/anggota-dashboard">
                ...
                <table class="table table-hover text-nowrap text-center">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <a href="anggota-dashboard/{{$anggota->id}}/edit" class="btn btn-success btn-sm"><i class="fa fa-edit"></i></a>
                        <form action="/anggota-dashboard/{{$anggota->id}}" method="post" class="d-inline">
                          @method('DELETE')
                          @csrf
                        ...
                        <a href="anggota-dashboard/{{$anggota->id}}" class="btn btn-sm" style="background-color: #4682B4;color: white;"><i class="fa fa-eye"></i></a>
                      </td>
                    </tr>
                    @empty
